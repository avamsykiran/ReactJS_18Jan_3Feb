...
const StatementSummary = (props) => {
    ...
    let tc = useSelector(globalState => globalState.totalCredit);
    let td = useSelector(globalState => globalState.totalDebit);
    let bal = useSelector(globalState => globalState.balance);
